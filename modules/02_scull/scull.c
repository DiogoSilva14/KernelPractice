...
#ifdef SCULL_DEBUG /* proc implementation for debugging */
/*
 * Proc fs: function to read and entry
 */
...
{
    /* Nothing to do since no cleanup is necessary */
}
...
/*
 * Create (and remove) the /proc file(s)
 */
